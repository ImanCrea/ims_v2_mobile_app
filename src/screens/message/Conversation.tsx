            ...
            <View style={styles.conversationContainer}>
                <ScrollView style={{flex:1, paddingTop:15}}>
                    ...
                    <View style={styles.conversationListContainer}>
                        ...
                        <View style={styles.messageSenderContainer}>
                            ...
                            <View style={styles.senderTextContainer}>
                                <View style={styles.senderText}>
                                    <Text style={styles.senderTextColor}>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the. and typesetting industry. Lorem Ipsum has been the.
                                    </Text>
                                </View>
                                <View style={styles.timeTextSend}>
                        ...
                        <View style={styles.messageAnotherContainer}>
                            <View style={styles.anotherImageContainer}>
                            <View style={styles.anotherImage}>
                                <Image
                                    source={{
                                    ...
                                    resizeMode="cover"
                                    style={styles.anotherImageCover}
                                />
                            </View>
                            </View>

                            <View style={styles.anotherTextContainer}>
                                <View style={styles.anotherText}>
                                    <Text style={styles.anotherTextColor}>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the. and typesetting industry. Lorem Ipsum has been the.
                                    </Text>
                                </View>
                                <View style={styles.timeTextAnother}>
                                    <Text style={styles.timeTextAnotherFont}>13:50</Text>
                                </View>
                            </View>
                        </View>  
            ...
            <View style={styles.textareaContainer}>
                <View style={styles.textareaFieldContainer}>
                    <View style={styles.fileUploadContanier}>
                        <MaterialIcons name="attach-file" size={28} color={COLORS.grayLight} />
                    </View>
                    ...
                    <View style={styles.sendButtonContainer}>
                        <TouchableOpacity activeOpacity={0.7} onPress={() => {}}>
                            <MaterialCommunityIcons name="send" size={28} color={COLORS.primary} disabled />
                        </TouchableOpacity>
                    </View>
